      ...
      <div className="mx-auto max-w-6xl px-6">
        <Reveal>
          <h2 className="text-center text-4xl md:text-5xl font-black tracking-tighter mb-14">
            ...
            <span className="text-gradient-gold">Been on the Job Site</span>
          </h2>
        </Reveal>
        <Reveal>
          <figure className="relative max-w-3xl mx-auto rounded-2xl border border-gold/30 bg-card p-10 shadow-card">
            <Quote className="absolute -top-5 left-8 h-10 w-10 text-gold bg-background p-1.5 rounded-full" />
            ...
            <figcaption className="mt-6 flex items-center gap-3">
              <div className="h-10 w-10 rounded-full bg-gradient-gold flex items-center justify-center font-black text-background">
                O
              </div>
              <div>
